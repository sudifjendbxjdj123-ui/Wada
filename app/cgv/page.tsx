      ...
      <div className="wada-container" style={{ padding: "0 32px 80px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <header style={{ textAlign: "center", padding: "40px 0 48px" }}>
            ...
            <h1 style={{ fontSize: 56, fontWeight: 400, margin: 0, fontFamily: "'Fredoka', sans-serif" }}>Conditions générales</h1>
          </header>
          <article style={{ fontSize: 16, lineHeight: 1.8, color: ink, fontFamily: "'Inter', sans-serif" }}>

            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 1 — Objet et acceptation</h2>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 2 — Description du service</h2>
            <p style={{ color: textSecondary, marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 3 — Tarifs (EUR)</h2>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 4 — Paiement</h2>
            <p style={{ color: textSecondary, marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 5 — Résiliation</h2>
            <p style={{ color: textSecondary, marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 8 — Responsabilité</h2>
            <p style={{ color: textSecondary, marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 9 — Propriété intellectuelle</h2>
            <p style={{ color: textSecondary, marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 10 — Données personnelles</h2>
            <p style={{ color: textSecondary, marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 11 — Modifications</h2>
            <p style={{ color: textSecondary, marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: 24, margin: "32px 0 16px" }}>Article 12 — Droit applicable et juridiction</h2>
